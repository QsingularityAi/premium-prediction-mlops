...
class TestModelTrainer(unittest.TestCase):
    ...
    def test_analyze_feature_importance(self):
        ...
        result = self.model_trainer.analyze_feature_importance(
            trained_models, self.segment_data_train, self.test_dir
        )
