...
class TestAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_app_predictor.segment_models = {'medium': MagicMock()}  # Simulate loaded models
        self.mock_app_predictor.predict.return_value = self.mock_success_result
        self.mock_app_predictor.predict_batch.return_value = self.mock_batch_success_result
    ...
    @unittest.skip("Skipping metrics endpoint test due to PROMETHEUS_MULTIPROC_DIR requirement")
